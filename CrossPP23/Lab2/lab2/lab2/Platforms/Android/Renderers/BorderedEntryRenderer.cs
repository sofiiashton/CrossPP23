    ...
    public class BorderedEntryRenderer : Microsoft.Maui.Controls.Handlers.Compatibility.ViewRenderer<BorderedEntry, AndroidWidget.EditText>
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<BorderedEntry> e)
        {
            ...
            if (e.NewElement != null)
            {
                ...
                var gradientDrawable = new GradientDrawable(); gradientDrawable.SetColor(AndroidGraphics.Color.White); gradientDrawable.SetStroke(2, AndroidGraphics.Color.Blue); gradientDrawable.SetCornerRadius(10); Control.SetBackground(gradientDrawable);
            }
        }
    }
}